...
export const useAdminAuth = () => {
  ...
  // Handle login with database credentials first, then fallback to hard-coded
  const handleLogin = async (username: string, password: string) => {
    try {
      console.log("Attempting login with:", username);

      // First, try database credentials (priority)
      ...
      console.log("Database credentials check for:", adminCredentials);

      // Check if provided credentials match stored credentials (PRIORITY)
      ...
      // Fallback to hard-coded credentials for emergency access
      ...
      if (validPasswords.includes(password) && validUsernames.includes(username.toLowerCase())) {
        console.log("✅ Login successful with fallback hard-coded credentials");
        ...
        toast({
          ...
          description: "Welcome to the admin panel! (Using fallback credentials)",
        });
