...
import { Loader2, Phone, Mail, User, MapPin, CheckCircle, AlertCircle } from 'lucide-react';
    ...
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        ...
        <div className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm text-gray-500 overflow-x-auto">
          <div className={`flex items-center gap-1 flex-shrink-0 ${currentStep >= 1 ? 'text-blue-600' : ''}`}>
            <div className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full flex items-center justify-center text-xs admin-touch-target ${currentStep >= 1 ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}>1</div>
            <span className="hidden sm:inline">Order Details</span>
            <span className="sm:hidden">Order</span>
          </div>
          <div className="w-4 sm:w-8 h-px bg-gray-300 flex-shrink-0"></div>
          <div className={`flex items-center gap-1 flex-shrink-0 ${currentStep >= 2 ? 'text-blue-600' : ''}`}>
            <div className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full flex items-center justify-center text-xs admin-touch-target ${currentStep >= 2 ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}>2</div>
            <span>Address</span>
          </div>
          <div className="w-4 sm:w-8 h-px bg-gray-300 flex-shrink-0"></div>
          <div className={`flex items-center gap-1 flex-shrink-0 ${currentStep >= 3 ? 'text-blue-600' : ''}`}>
            <div className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full flex items-center justify-center text-xs admin-touch-target ${currentStep >= 3 ? 'bg-blue-600 text-white' : 'bg-gray-200'}`}>3</div>
            <span>Payment</span>
          </div>
        </div>
      </CardHeader>
