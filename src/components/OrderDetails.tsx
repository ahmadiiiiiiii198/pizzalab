  ...
  return (
    <Card className="border-emerald-200 shadow-lg">
      ...
      <CardContent className="space-y-4 sm:space-y-6 md:space-y-8 pt-4 sm:pt-6 p-3 sm:p-4 md:p-6">
        ...
        {/* Payment Information */}
        <div className="bg-blue-50 p-3 sm:p-4 rounded-lg border border-blue-200">
          <h4 className="font-bold mb-3 sm:mb-4 text-sm sm:text-base md:text-lg text-gray-800 border-b border-blue-300 pb-2">Informazioni Pagamento</h4>
          <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm md:text-base">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
              ...
              <span className="font-semibold text-blue-700">
                ...
                {!order.payment_method && '❓ Non specificato'}
              </span>
            </div>
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
              ...
              <span className={`font-semibold ${
                ...
                {!order.payment_status && '❓ Non specificato'}
              </span>
            </div>
            {order.delivery_fee && order.delivery_fee > 0 && (
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
                <strong className="text-gray-700">Spesa di Consegna:</strong>
                <span className="font-semibold text-blue-700">€{order.delivery_fee.toFixed(2)}</span>
              </div>
            )}
            {order.payment_method === 'pos' && order.metadata?.posFee && (
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
                <strong className="text-gray-700">Spesa POS a Domicilio:</strong>
                <span className="font-semibold text-blue-700">€{order.metadata.posFee.toFixed(2)}</span>
              </div>
            )}
          </div>
        </div>
